...
# datasetname = 'all-mias'
# datasetname = 'coco-animals'
datasetname = 'skin-cancer'
parser = argparse.ArgumentParser()
# parser.add_argument('--train_dir', default='coco-animals/train')
# parser.add_argument('--val_dir', default='coco-animals/val')
# parser.add_argument('--train_dir', default=datasetname+'/train')
# parser.add_argument('--val_dir', default=datasetname+'/val')
...
parser.add_argument('--batch_size', default=32, type=int)
parser.add_argument('--num_workers', default=4, type=int)
parser.add_argument('--num_epochs1', default=1000, type=int)
...
def main(args):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        for epoch in range(args.num_epochs2):
            ...
            print('Train accuracy: %f' % train_acc)
            print('Val accuracy: %f\n' % val_acc)
            saver.save(sess, './output/'+datasetname+'/vgg_fine.ckpt')
